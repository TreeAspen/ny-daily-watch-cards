/* mp4box.js 0.5.2 — vendored, BSD-3-Clause (https://github.com/gpac/mp4box.js).
   Used only to read a clip's own frames and their own timestamps, so footage
   can pass through the export without being resampled onto a fixed grid.
   Loaded as a classic script; it defines window.MP4Box. */
/*! mp4box 19-03-2022 */
